...
class CustomMultiLossLayer(nn.Module):
    ...
    this is a loss with learnable parameter
    """
...
class ICLLoss(nn.Module):
    ...
    def forward(self, emb, data_dict):
        ...
        e1i = emb[data_dict['e1i']] # this should be the matched nodes of the query to positive
        e2i = emb[data_dict['e2i']] # this is the all matched nodes of the positives
        e1j = emb[data_dict['e1j']] # this should be the unmatched nodes of the query to negative
        e2j = emb[data_dict['e2j']] # this should be the unmatched nodes of the negatives
