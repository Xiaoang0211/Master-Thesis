...
import sys
sys.path.append('.')
from utilities.utils_node_match import common, define

def parse_args():
    parser = argparse.ArgumentParser()
    parser.add_argument('--split', dest='split', default='val', type=str, help='split to generate scan-subscan mapping on')
